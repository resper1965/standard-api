...
* **auth:** add structured event logging to auth middleware ([2e0837b](https://github.com/resper1965/standard-api/commit/2e0837b6100a823bb2946042b6c1e9b6d9da6b44))
* **auth:** migrate to self-hosted Better Auth, remove Neon Auth beta SDK ([66d3e51](https://github.com/resper1965/standard-api/commit/66d3e5191848c18101eabd7d9c7fe8418a1c602b))
...
* **auth:** remove redundant Drizzle field mappings that caused BetterAuthError ([ce25379](https://github.com/resper1965/standard-api/commit/ce253794f77145403dfc06378cd37e7b73c7471b))
* **auth:** revert incomplete Neon Auth migration, restore Better Auth ([#21](https://github.com/resper1965/standard-api/issues/21)) ([2bfb0c6](https://github.com/resper1965/standard-api/commit/2bfb0c61e306ce655c5b1da620154dd71064f873))
* **auth:** revert to official @neondatabase/neon-js/auth pattern ([c93e916](https://github.com/resper1965/standard-api/commit/c93e9162ac66ae9a96b7347ab7df285d31597f97))
