...
const DATA_SUBJECTS: DataSubjectRef[] = [
  ...
  },
  {
    ...
    examples_i18n: { pt: ["pessoa fÃ­sica consumidora"], en: ["consumer"] },
  ...
  },
  {
    ...
    default_legal_basis: "consent",
    examples_i18n: {
      pt: ["candidato a vaga de emprego"],
      en: ["job applicant"],
    },
    applicable_regulations: ["lgpd", "gdpr"],
    scf_controls: ["PRI-01", "HRS-01"],
  ...
  },
  {
    ...
    examples_i18n: {
      ...
      en: ["physical visitor", "website visitor"],
    },
    applicable_regulations: ["lgpd", "gdpr"],
  ...
  },
  {
    ...
    examples_i18n: {
      pt: ["paciente em clÃ­nica ou hospital"],
      en: ["clinic patient"],
    },
  ...
  },
  {
    ...
    default_legal_basis: "contract",
    examples_i18n: {
      pt: ["aluno de instituiÃ§Ã£o de ensino"],
      en: ["student"],
    },
    applicable_regulations: ["lgpd", "gdpr"],
    scf_controls: ["PRI-01"],
  ...
  },
  {
    ...
    default_legal_basis: "contract",
    examples_i18n: {
      pt: ["profissional PJ alocado", "temporÃ¡rio"],
      en: ["temp worker", "agency staff"],
    },
    applicable_regulations: ["lgpd", "gdpr"],
    scf_controls: ["PRI-01", "TPM-01"],
  },
  {
    ...
    examples_i18n: {
      pt: ["funcionÃ¡rio de Ã³rgÃ£o pÃºblico"],
...
// â”€â”€ Data Categories â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export const DATA_CATEGORIES: DataCategoryRef[] = [
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["nome", "CPF", "RG", "passaporte", "CNH"],
      en: ["name", "SSN", "passport"],
    },
    article_by_regulation: [
      {
        ...
        extra_requirement_i18n: { pt: "", en: "" },
      },
    ],
    examples_i18n: {
      pt: ["nome completo", "CPF", "RG"],
      en: ["full name", "SSN"],
    },
  ...
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["email", "telefone", "endereÃ§o", "celular"],
    ...
    examples_i18n: {
      pt: ["email", "telefone", "endereÃ§o residencial"],
      en: ["email", "phone"],
    },
    scf_controls: ["DCH-01", "PRI-01"],
    auto_triggers: [],
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["conta bancÃ¡ria", "cartÃ£o", "renda", "salÃ¡rio"],
      en: ["bank account", "credit card", "income"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["conta bancÃ¡ria", "cartÃ£o de crÃ©dito"],
      en: ["bank account", "credit card"],
    },
  ...
  },
  {
    ...
    keywords_i18n: {
      ...
      en: ["medical record", "diagnosis", "prescription"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
        ...
        extra_requirement_i18n: {
          pt: "Base legal do Art. 11 obrigatÃ³ria",
          en: "Art. 11 legal basis required",
        },
      },
      {
        ...
        article: "Â§160.103",
        extra_legal_basis_required: true,
        extra_requirement_i18n: { pt: "Regras PHI", en: "PHI rules apply" },
      },
    ],
    examples_i18n: {
      pt: ["prontuÃ¡rio mÃ©dico", "diagnÃ³stico"],
      en: ["medical history", "diagnosis"],
    },
    ...
    auto_triggers: [
      {
        ...
        condition_i18n: {
          pt: "Dados de saÃºde em larga escala",
          en: "Large scale health data",
        },
      },
    ],
  },
  {
    ...
    sensitivity: "special",
    keywords_i18n: {
      pt: ["impressÃ£o digital", "facial", "Ã­ris", "voz"],
      en: ["fingerprint", "facial", "iris"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
        ...
        extra_legal_basis_required: true,
        extra_requirement_i18n: {
          pt: "Consentimento especÃ­fico e destacado",
          en: "Explicit consent",
        },
      },
    ],
    examples_i18n: {
      pt: ["impressÃ£o digital", "reconhecimento facial"],
      en: ["fingerprint", "facial recognition"],
    },
    ...
    auto_triggers: [
      {
        trigger: "dpia_required",
        condition_i18n: {
          pt: "Tratamento de biometria",
          en: "Biometric processing",
        },
      },
    ],
  },
  {
    ...
    examples_i18n: {
      pt: ["sequenciamento genÃ©tico", "teste de paternidade"],
      en: ["genetic sequencing"],
    },
    scf_controls: ["DCH-01", "CRY-01", "PRI-05"],
    auto_triggers: [
      {
        trigger: "dpia_required",
        condition_i18n: { pt: "Dados genÃ©ticos", en: "Genetic data" },
      },
    ],
  },
  {
    ...
    sensitivity: "special",
    keywords_i18n: {
      pt: ["partido", "filiaÃ§Ã£o", "ideologia"],
      en: ["party", "ideology"],
    },
    article_by_regulation: [
      {
  ...
  },
  {
    ...
    sensitivity: "special",
    keywords_i18n: {
      pt: ["religiÃ£o", "crenÃ§a", "fÃ©"],
      en: ["religion", "belief", "faith"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["religiÃ£o", "crenÃ§as filosÃ³ficas"],
      en: ["religion", "philosophical belief"],
    },
    scf_controls: ["DCH-01", "PRI-05"],
    auto_triggers: [],
  },
  {
    ...
    sensitivity: "special",
    keywords_i18n: {
      pt: ["orientaÃ§Ã£o sexual", "vida sexual"],
    ...
    examples_i18n: { pt: ["orientaÃ§Ã£o sexual"], en: ["sexual orientation"] },
    scf_controls: ["DCH-01", "PRI-05"],
    auto_triggers: [],
  },
  {
    ...
    examples_i18n: { pt: ["raÃ§a", "etnia"], en: ["race", "ethnicity"] },
    scf_controls: ["DCH-01", "PRI-05"],
    auto_triggers: [],
  },
  {
    ...
    sensitivity: "criminal",
    keywords_i18n: {
      pt: ["antecedentes", "condenaÃ§Ã£o", "processo criminal"],
      en: ["criminal record", "conviction"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
      ...
      },
      {
        ...
        extra_legal_basis_required: true,
        extra_requirement_i18n: {
          pt: "Somente sob controle de autoridade",
          en: "Only under official authority",
        },
      },
    ],
    examples_i18n: {
      pt: ["antecedentes criminais", "condenaÃ§Ãµes"],
      en: ["criminal records", "convictions"],
    },
    ...
    article_by_regulation: [
      {
        ...
        extra_legal_basis_required: true,
        extra_requirement_i18n: {
          pt: "Consentimento de responsÃ¡vel legal",
          en: "Guardian consent",
        },
      },
    ],
    examples_i18n: {
      pt: ["dados de menores de 12 anos"],
      en: ["data of minors under 12"],
    },
    scf_controls: ["DCH-01", "PRI-05"],
    auto_triggers: [
      {
        trigger: "dpia_required",
        condition_i18n: {
          pt: "Tratamento de dados de menores",
          en: "Processing minors data",
        },
      },
    ],
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["navegaÃ§Ã£o", "cookies", "preferÃªncias", "click"],
      en: ["browsing", "cookies", "preferences", "clicks"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["histÃ³rico de navegaÃ§Ã£o", "compras"],
      en: ["browsing history", "purchases"],
    },
    scf_controls: ["DCH-01", "PRI-01"],
    auto_triggers: [
      {
        ...
        condition_i18n: {
          pt: "Pode configurar profiling",
          en: "May constitute profiling",
        },
      },
    ],
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["GPS", "IP", "localizaÃ§Ã£o", "coordenadas"],
      en: ["GPS", "IP", "location", "coordinates"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: { pt: ["GPS", "endereÃ§o IP"], en: ["GPS", "IP address"] },
    scf_controls: ["DCH-01", "PRI-01"],
    auto_triggers: [
      {
        trigger: "dpia_check",
  ...
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["cargo", "empresa anterior", "currÃ­culo"],
      en: ["job title", "previous employer", "resume"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["cargo", "empresa", "experiÃªncia"],
      en: ["job title", "company", "experience"],
    },
  ...
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["foto", "imagem", "vÃ­deo", "CFTV"],
      en: ["photo", "image", "video", "CCTV"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["foto de documento", "gravaÃ§Ã£o CFTV"],
      en: ["ID photo", "CCTV recording"],
    },
  ...
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["diploma", "certificado", "escolaridade"],
      en: ["diploma", "certificate", "education level"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["diploma", "histÃ³rico escolar"],
      en: ["diploma", "academic transcript"],
    },
    scf_controls: ["DCH-01", "HRS-01"],
    auto_triggers: [],
  },
  {
    ...
    sensitivity: "special",
    keywords_i18n: {
      pt: ["sindicato", "filiaÃ§Ã£o sindical"],
      en: ["union", "trade union membership"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
  ...
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["processo", "aÃ§Ã£o judicial", "litÃ­gio"],
    ...
    examples_i18n: {
      pt: ["processos judiciais", "aÃ§Ãµes trabalhistas"],
      en: ["court cases", "labor claims"],
    },
    scf_controls: ["DCH-01"],
    auto_triggers: [],
  },
  {
    ...
    sensitivity: "normal",
    keywords_i18n: {
      pt: ["gravaÃ§Ã£o", "voz", "call center"],
      en: ["recording", "voice", "call center"],
    },
    article_by_regulation: [
      {
        regulation_id: "lgpd",
    ...
    examples_i18n: {
      pt: ["gravaÃ§Ã£o de call center", "mensagem de voz"],
      en: ["call center recording", "voicemail"],
    },
    scf_controls: ["DCH-01", "PRI-01"],
    auto_triggers: [],
  },
...
// â”€â”€ Retention Rules â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

export const RETENTION_RULES: RetentionRuleRef[] = [
  {
    data_category_id: "identification",
    context_id: "rh",
    context_i18n: { pt: "RelaÃ§Ã£o trabalhista", en: "Employment relation" },
    period_i18n: { pt: "5 a 30 anos", en: "5 to 30 years" },
    min_months: 60,
    max_months: 360,
  ...
  },
  {
    ...
    context_i18n: { pt: "Marketing", en: "Marketing" },
    period_i18n: { pt: "AtÃ© revogaÃ§Ã£o", en: "Until revoked" },
    min_months: 0,
    max_months: null,
  ...
  {
    data_category_id: "financial",
    context_id: "fiscal",
    context_i18n: { pt: "Fiscal", en: "Tax" },
    period_i18n: { pt: "5 a 10 anos", en: "5 to 10 years" },
    min_months: 60,
    max_months: 120,
    legal_basis: "CTN Art. 173",
    jurisdiction: "BR",
    disposal_method: "crypto_shred",
    scf_controls: ["DCH-17", "CRY-01"],
  },
  {
    data_category_id: "health",
    context_id: "health_record",
    context_i18n: { pt: "ProntuÃ¡rio mÃ©dico", en: "Health record" },
    period_i18n: { pt: "20+ anos", en: "20+ years" },
    min_months: 240,
    max_months: null,
  ...
  },
  {
    ...
    context_id: "access",
    context_i18n: { pt: "Controle de acesso", en: "Access control" },
    period_i18n: { pt: "Durante contrato", en: "During contract" },
    min_months: 0,
    max_months: 60,
  ...
  {
    data_category_id: "criminal",
    context_id: "bg_check",
    context_i18n: { pt: "Background check", en: "Background check" },
    period_i18n: { pt: "Durante processo", en: "During process" },
    min_months: 0,
    max_months: 24,
  ...
  {
    data_category_id: "behavioral",
    context_id: "analytics",
    context_i18n: { pt: "Analytics", en: "Analytics" },
    period_i18n: { pt: "AtÃ© 2 anos", en: "Up to 2 years" },
    min_months: 0,
    max_months: 24,
    legal_basis: "Consentimento",
    jurisdiction: "BR",
  ...
  {
    data_category_id: "geolocation",
    context_id: "fleet",
    context_i18n: { pt: "Fleet management", en: "Fleet management" },
    period_i18n: { pt: "1 a 3 anos", en: "1 to 3 years" },
    min_months: 12,
    max_months: 36,
    legal_basis: "Contrato",
    jurisdiction: "BR",
...
const LIFE_CYCLE_STAGES: LifeCycleStageRef[] = [
  {
    id: "collection",
    name_i18n: { pt: "Coleta", en: "Collection" },
    order: 1,
    description_i18n: { pt: "ObtenÃ§Ã£o dos dados", en: "Data acquisition" },
    scf_controls: ["PRI-01", "PRI-03"],
    articles_by_regulation: { gdpr: "Art. 13-14", lgpd: "Art. 7" },
  },
  {
    id: "processing",
    name_i18n: { pt: "Processamento", en: "Processing" },
    order: 2,
    description_i18n: {
      pt: "OperaÃ§Ãµes realizadas",
      en: "Operations performed",
    },
    scf_controls: ["PRI-01", "DCH-01"],
    articles_by_regulation: { gdpr: "Art. 5(1)(b)", lgpd: "Art. 6" },
  },
  {
    id: "storage",
    name_i18n: { pt: "Armazenamento", en: "Storage" },
    order: 3,
    description_i18n: { pt: "Guarda dos dados", en: "Data warehousing" },
    scf_controls: ["DCH-01", "CRY-01", "CRY-09"],
    articles_by_regulation: { gdpr: "Art. 5(1)(e)", lgpd: "Art. 6, VII" },
  },
  {
    id: "sharing",
    name_i18n: { pt: "Compartilhamento", en: "Sharing" },
    order: 4,
    description_i18n: {
      pt: "TransmissÃ£o a terceiros",
      en: "Transmission to third parties",
    },
    scf_controls: ["PRI-03", "TPM-01", "DCH-01"],
    articles_by_regulation: { gdpr: "Art. 26-28", lgpd: "Art. 26-27" },
  },
  {
    id: "archiving",
    name_i18n: { pt: "Arquivamento", en: "Archiving" },
    order: 5,
    description_i18n: { pt: "Guarda prolongada", en: "Long-term storage" },
    scf_controls: ["DCH-17", "PRI-01"],
    articles_by_regulation: { gdpr: "Art. 5(1)(e)", lgpd: "Art. 16" },
  },
  {
    id: "disposal",
    name_i18n: { pt: "EliminaÃ§Ã£o", en: "Disposal" },
    order: 6,
    description_i18n: { pt: "DestruiÃ§Ã£o", en: "Destruction" },
    scf_controls: ["DCH-17", "DCH-18"],
    articles_by_regulation: { gdpr: "Art. 17", lgpd: "Art. 16" },
  },
];
...
const DATA_ORIGINS: DataOriginRef[] = [
  {
    ...
    name_i18n: {
      pt: "Coleta direta do titular",
      en: "Direct collection from subject",
    },
  ...
  },
  {
    id: "third_party",
    name_i18n: {
      pt: "Recebido de terceiros",
      en: "Received from third parties",
    },
    requires_consent_notice: true,
    scf_controls: ["PRI-01", "PRI-03", "TPM-01"],
  },
  {
    id: "public_source",
    name_i18n: {
      pt: "Fonte publicamente disponÃ­vel",
      en: "Publicly available source",
    },
    requires_consent_notice: false,
    scf_controls: ["PRI-01"],
  },
  {
    id: "automated",
    name_i18n: {
      pt: "Coleta automatizada (cookies, logs)",
      en: "Automated collection (cookies, logs)",
    },
    requires_consent_notice: true,
    scf_controls: ["PRI-01", "PRI-03"],
  },
  {
    ...
    name_i18n: { pt: "Gerado internamente", en: "Internally generated" },
    requires_consent_notice: false,
    scf_controls: ["PRI-01"],
  },
  {
    id: "legal_obligation",
    name_i18n: {
      pt: "Recebido por obrigaÃ§Ã£o legal",
      en: "Received by legal obligation",
    },
    requires_consent_notice: false,
    scf_controls: ["PRI-01", "CPL-01"],
  },
];
...
const COLLECTION_METHODS: CollectionMethodRef[] = [
  {
    id: "web_form",
    name_i18n: { pt: "FormulÃ¡rio web", en: "Web form" },
  ...
  {
    id: "paper_form",
    name_i18n: { pt: "FormulÃ¡rio fÃ­sico", en: "Paper form" },
    requires_consent_checkbox: true,
    privacy_notice_required: true,
    scf_controls: ["PRI-01"],
  },
  {
    id: "api_integration",
    name_i18n: { pt: "IntegraÃ§Ã£o via API", en: "API Integration" },
    requires_consent_checkbox: false,
    privacy_notice_required: false,
    scf_controls: ["PRI-01", "TPM-01"],
  },
  {
    id: "email",
    name_i18n: { pt: "Email", en: "Email" },
    requires_consent_checkbox: false,
    privacy_notice_required: true,
    scf_controls: ["PRI-01"],
  },
  {
    id: "phone",
    name_i18n: { pt: "Telefone/Call Center", en: "Phone/Call Center" },
    requires_consent_checkbox: false,
    privacy_notice_required: true,
    scf_controls: ["PRI-01"],
  },
  {
    id: "in_person",
    name_i18n: { pt: "Presencial", en: "In person" },
    requires_consent_checkbox: false,
    privacy_notice_required: true,
    scf_controls: ["PRI-01"],
  },
  {
    id: "cookies_tracking",
    name_i18n: { pt: "Cookies/Tracking", en: "Cookies/Tracking" },
    requires_consent_checkbox: true,
    privacy_notice_required: true,
    scf_controls: ["PRI-01", "PRI-03"],
  },
  {
    id: "cftv",
    name_i18n: { pt: "CFTV/CÃ¢meras", en: "CCTV/Cameras" },
    requires_consent_checkbox: false,
    privacy_notice_required: true,
    scf_controls: ["PES-01", "PRI-01"],
  },
  {
    id: "biometric_scanner",
    name_i18n: { pt: "Leitor biomÃ©trico", en: "Biometric scanner" },
    requires_consent_checkbox: true,
    privacy_notice_required: true,
    scf_controls: ["IAC-15", "PRI-01"],
  },
];
...
const PROCESSING_PURPOSES: ProcessingPurposeRef[] = [
  {
    ...
    name_i18n: { pt: "GestÃ£o de Empregados", en: "Employee Management" },
    category: "rh",
    typical_legal_basis: "contract",
    typical_retention_i18n: {
      pt: "5 anos apÃ³s desligamento",
      en: "5 years post termination",
    },
    dpia_likely: false,
    examples_i18n: {
      pt: ["folha de pagamento", "gestÃ£o de fÃ©rias"],
      en: ["payroll", "vacation management"],
    },
    scf_controls: ["PRI-01", "HRS-01"],
  },
  {
    id: "recruitment",
    name_i18n: { pt: "Recrutamento e SeleÃ§Ã£o", en: "Recruitment" },
    category: "rh",
    typical_legal_basis: "consent",
    typical_retention_i18n: { pt: "2 anos", en: "2 years" },
    dpia_likely: false,
    examples_i18n: {
      pt: ["anÃ¡lise de currÃ­culo", "entrevista"],
      en: ["resume review", "interviews"],
    },
    scf_controls: ["PRI-01", "HRS-01"],
  },
  {
    id: "payroll",
    name_i18n: { pt: "Folha de Pagamento", en: "Payroll" },
    category: "rh",
    typical_legal_basis: "legal_obligation",
    typical_retention_i18n: { pt: "30 anos (FGTS)", en: "30 years" },
    dpia_likely: false,
    examples_i18n: {
      pt: ["cÃ¡lculo de salÃ¡rio", "encargos"],
      en: ["salary calculation", "taxes"],
    },
    scf_controls: ["PRI-01", "HRS-01"],
  },
  {
    ...
    category: "marketing",
    typical_legal_basis: "consent",
    typical_retention_i18n: { pt: "AtÃ© revogaÃ§Ã£o", en: "Until revoked" },
    dpia_likely: false,
    examples_i18n: {
      pt: ["envio de newsletter", "promoÃ§Ãµes"],
      en: ["newsletters", "promotions"],
    },
    scf_controls: ["PRI-01", "PRI-03"],
  },
  {
    id: "marketing_analytics",
    name_i18n: { pt: "Analytics de Marketing", en: "Marketing Analytics" },
    category: "marketing",
    typical_legal_basis: "legitimate_interest",
    typical_retention_i18n: { pt: "2 anos", en: "2 years" },
    dpia_likely: true,
    examples_i18n: {
      pt: ["anÃ¡lise comportamental", "segmentaÃ§Ã£o"],
      en: ["behavior analysis", "segmentation"],
    },
    scf_controls: ["PRI-01", "PRI-05"],
  },
  {
    id: "contract_execution",
    name_i18n: { pt: "ExecuÃ§Ã£o de Contrato", en: "Contract Execution" },
    category: "juridico",
    typical_legal_basis: "contract",
    typical_retention_i18n: { pt: "10 anos", en: "10 years" },
    dpia_likely: false,
    examples_i18n: {
      pt: ["prestaÃ§Ã£o de serviÃ§o", "entrega de produto"],
      en: ["service delivery", "product fulfillment"],
    },
    scf_controls: ["PRI-01"],
  },
  {
    id: "legal_compliance",
    name_i18n: { pt: "Conformidade Legal", en: "Legal Compliance" },
    category: "compliance",
    typical_legal_basis: "legal_obligation",
    typical_retention_i18n: { pt: "Conforme legislaÃ§Ã£o", en: "As per law" },
    dpia_likely: false,
    examples_i18n: {
      pt: ["obrigaÃ§Ãµes fiscais", "relatÃ³rios regulatÃ³rios"],
      en: ["tax obligations", "regulatory reports"],
    },
    scf_controls: ["PRI-01", "CPL-01"],
  },
  {
    id: "security_monitoring",
    name_i18n: { pt: "Monitoramento de SeguranÃ§a", en: "Security Monitoring" },
    category: "ti",
    typical_legal_basis: "legitimate_interest",
    typical_retention_i18n: { pt: "1 ano", en: "1 year" },
    dpia_likely: true,
    examples_i18n: {
      pt: ["SIEM", "logs de acesso", "DLP"],
      en: ["SIEM", "access logs", "DLP"],
    },
    scf_controls: ["MON-01", "PRI-01"],
  },
  {
    id: "vendor_management",
    name_i18n: { pt: "GestÃ£o de Fornecedores", en: "Vendor Management" },
    category: "compras",
    typical_legal_basis: "contract",
    typical_retention_i18n: {
      pt: "5 anos apÃ³s fim do contrato",
      en: "5 years post contract",
    },
    dpia_likely: false,
    examples_i18n: {
      pt: ["cadastro de fornecedor", "due diligence"],
      en: ["vendor onboarding", "due diligence"],
    },
    scf_controls: ["TPM-01", "PRI-01"],
  },
  {
    id: "fraud_prevention",
    ...
    dpia_likely: true,
    examples_i18n: {
      pt: ["anÃ¡lise antifraude", "KYC"],
      en: ["anti-fraud analysis", "KYC"],
    },
...
const SECURITY_MEASURES: SecurityMeasureRef[] = [
  {
    ...
    name_i18n: { pt: "Criptografia em repouso", en: "Encryption at rest" },
    category: "technical",
    scf_controls: ["CRY-01", "CRY-09"],
    applicable_data_categories: ["all"],
    priority_for_sensitive: "mandatory",
    priority_for_normal: "recommended",
  },
  {
  ...
  },
  {
    ...
    priority_for_sensitive: "recommended",
    priority_for_normal: "optional",
  },
  {
    id: "privacy_policy",
...
const DISPOSAL_METHODS: DisposalMethodRef[] = [
  {
    id: "secure_delete",
    name_i18n: { pt: "ExclusÃ£o segura (wipe)", en: "Secure deletion (wipe)" },
    description_i18n: {
      pt: "Sobrescrita de dados em mÃ­dia",
      en: "Data overwrite on media",
    },
    applicable_to: "digital",
    scf_controls: ["DCH-17", "DCH-18"],
    articles_by_regulation: { lgpd: "Art. 16" },
  },
  {
    id: "crypto_shred",
    name_i18n: { pt: "Crypto shredding", en: "Crypto shredding" },
    description_i18n: {
      pt: "DestruiÃ§Ã£o da chave de criptografia",
      en: "Encryption key destruction",
    },
    applicable_to: "digital",
  ...
  },
  {
    ...
    description_i18n: {
      pt: "TrituraÃ§Ã£o ou incineraÃ§Ã£o",
      en: "Shredding or incineration",
    },
    applicable_to: "both",
    scf_controls: ["DCH-17", "DCH-18"],
    articles_by_regulation: { lgpd: "Art. 16" },
  },
  {
    ...
    description_i18n: {
      pt: "Tornar impossÃ­vel a identificaÃ§Ã£o",
      en: "Make identification impossible",
    },
    applicable_to: "digital",
    scf_controls: ["PRI-01", "DCH-17"],
    articles_by_regulation: { lgpd: "Art. 12, Â§1Â°" },
  },
  {
    id: "paper_shredding",
    name_i18n: { pt: "TrituraÃ§Ã£o de papel", en: "Paper shredding" },
    description_i18n: {
      pt: "DestruiÃ§Ã£o de documentos fÃ­sicos",
      en: "Destruction of physical documents",
    },
    applicable_to: "physical",
    scf_controls: ["DCH-18"],
    articles_by_regulation: { lgpd: "Art. 16" },
  },
];
...
const RISK_FACTORS: RiskFactorRef[] = [
  {
    ...
    description_i18n: {
      pt: "Envolve dados especiais",
      en: "Involves special categories",
    },
    weight: 3,
    triggers_dpia: true,
    triggers_lia: false,
    regulation_refs: ["LGPD Art. 11", "GDPR Art. 9"],
  ...
  },
  {
    ...
    description_i18n: { pt: "Volume significativo", en: "Significant volume" },
    weight: 3,
    triggers_dpia: true,
    triggers_lia: false,
    regulation_refs: ["GDPR Art. 35(3)(b)"],
  ...
  },
  {
    ...
    description_i18n: {
      pt: "Envolve crianÃ§as/adolescentes",
      en: "Involves children/teens",
    },
    weight: 3,
    triggers_dpia: true,
    triggers_lia: false,
    regulation_refs: ["LGPD Art. 14"],
  ...
  },
  {
    ...
    description_i18n: {
      pt: "DecisÃµes automÃ¡ticas",
      en: "Automatic decisions",
    },
    weight: 3,
    triggers_dpia: true,
    triggers_lia: false,
    regulation_refs: ["LGPD Art. 20", "GDPR Art. 22"],
  ...
  },
  {
    ...
    description_i18n: {
      pt: "AnÃ¡lise comportamental",
      en: "Behavioral analysis",
    },
    weight: 2,
    triggers_dpia: true,
    triggers_lia: false,
    regulation_refs: ["GDPR Art. 35(3)(a)"],
...
// â”€â”€ Governance Reference Data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const MATURITY_LEVELS: MaturityLevelRef[] = [
  {
    ...
    description_i18n: {
      pt: "Processos ad-hoc, reativos.",
      en: "Ad-hoc, reactive processes.",
    },
  },
  {
    level: 2,
    ...
    description_i18n: {
      pt: "Processos bÃ¡sicos documentados.",
      en: "Basic documented processes.",
    },
  },
  {
    level: 3,
    ...
    description_i18n: {
      pt: "Processos padronizados e institucionalizados.",
      en: "Standardized processes.",
    },
  },
  {
    level: 4,
    ...
    description_i18n: {
      pt: "MÃ©tricas e KPIs definidos.",
      en: "Metrics and KPIs defined.",
    },
  },
  {
    level: 5,
    ...
    description_i18n: {
      pt: "Melhoria contÃ­nua e inovaÃ§Ã£o.",
...
const BG_CHECK_TYPES: BgCheckTypeRef[] = [
  ...
  {
    id: "education",
    name_i18n: { pt: "VerificaÃ§Ã£o de Escolaridade", en: "Education Check" },
    scf_controls: ["HRS-04"],
    required_for_clearance: ["privileged"],
  },
  {
    id: "employment",
    name_i18n: { pt: "VerificaÃ§Ã£o de Empregos", en: "Employment Check" },
    scf_controls: ["HRS-04"],
    required_for_clearance: ["elevated", "privileged"],
  },
  {
...
export const referenceDataRoutes: RouteDefinition[] = [
  ...
  },
  {
    ...
    handler: async ({ request, traceId }) => {
      ...
      return json(
        flattenI18n(
          { data: filtered, total: filtered.length, trace_id: traceId },
  ...
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: RETENTION_RULES, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: LIFE_CYCLE_STAGES, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: DATA_ORIGINS, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: COLLECTION_METHODS, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
    ...
    handler: async ({ request, traceId }) => {
      ...
      if (sensitivity === "special")
        filtered = filtered.filter(
          (m) => m.priority_for_sensitive !== "optional",
        );
      return json(
        flattenI18n(
          { data: filtered, total: filtered.length, trace_id: traceId },
  ...
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: DISPOSAL_METHODS, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: RISK_FACTORS, total: RISK_FACTORS.length, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: VOLUME_SCALE, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  ...
  // GOVERNANCE
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: MATURITY_LEVELS, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  ...
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: CLEARANCE_LEVELS, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
  {
    ...
    handler: async ({ request, traceId }) =>
      json(
        flattenI18n(
          { data: DEPARTMENTS, total: DEPARTMENTS.length, trace_id: traceId },
          new URL(request.url).searchParams.get("locale") ?? "",
        ),
      ),
  },
