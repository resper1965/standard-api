...
--
-- Hardening (2026-08-26 audit, finding A-01):
--   - FORCE ROW LEVEL SECURITY on every table. Without it PostgreSQL exempts the
--     table OWNER from RLS, and the application typically connects as the Neon
--     schema owner - which would make every policy below inert.
--   - WITH CHECK mirrors USING on every policy. USING alone filters reads; it
--     does not stop an INSERT/UPDATE from writing a row belonging to another
--     organization.
--
-- Policy design:
...
DROP POLICY IF EXISTS "rls_assessment_frameworks" ON "assessment_frameworks";
...
DROP POLICY IF EXISTS "rls_assessment_events" ON "assessment_events";
...
DROP POLICY IF EXISTS "rls_approval_events" ON "approval_events";
...
DROP POLICY IF EXISTS "rls_document_versions" ON "document_versions";
...
DROP POLICY IF EXISTS "rls_document_chunks" ON "document_chunks";
...
DROP POLICY IF EXISTS "rls_document_extraction_jobs" ON "document_extraction_jobs";
...
DROP POLICY IF EXISTS "rls_kb_entries" ON "kb_entries";
...
ALTER TABLE "vector_references" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_vector_references" ON "vector_references";
...
ALTER TABLE "kb_embedding_jobs" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_kb_embedding_jobs" ON "kb_embedding_jobs";
...
ALTER TABLE "kb_search_logs" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_kb_search_logs" ON "kb_search_logs";
...
ALTER TABLE "assessment_scope" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_assessment_scope" ON "assessment_scope";
...
ALTER TABLE "soa_versions" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_soa_versions" ON "soa_versions";
...
DROP POLICY IF EXISTS "rls_soa_items" ON "soa_items";
...
DROP POLICY IF EXISTS "rls_agent_runs" ON "agent_runs";
...
DROP POLICY IF EXISTS "rls_agent_decisions" ON "agent_decisions";
...
DROP POLICY IF EXISTS "rls_agent_tool_calls" ON "agent_tool_calls";
...
ALTER TABLE "evidence_findings" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_evidence_findings" ON "evidence_findings";
...
DROP POLICY IF EXISTS "rls_evidence_sources" ON "evidence_sources";
...
ALTER TABLE "gap_analysis_versions" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_gap_analysis_versions" ON "gap_analysis_versions";
...
ALTER TABLE "gap_findings" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_gap_findings" ON "gap_findings";
...
ALTER TABLE "maturity_assessment_versions" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_maturity_assessment_versions" ON "maturity_assessment_versions";
...
DROP POLICY IF EXISTS "rls_maturity_scores" ON "maturity_scores";
...
ALTER TABLE "poam_versions" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_poam_versions" ON "poam_versions";
...
ALTER TABLE "poam_items" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_poam_items" ON "poam_items";
...
ALTER TABLE "poam_milestones" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_poam_milestones" ON "poam_milestones";
...
ALTER TABLE "poam_dependencies" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_poam_dependencies" ON "poam_dependencies";
...
DROP POLICY IF EXISTS "rls_report_versions" ON "report_versions";
...
DROP POLICY IF EXISTS "rls_report_artifacts" ON "report_artifacts";
...
DROP POLICY IF EXISTS "rls_export_jobs" ON "export_jobs";
...
ALTER TABLE "traceability_links" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_traceability_links" ON "traceability_links";
...
DROP POLICY IF EXISTS "rls_workflow_audit_events" ON "workflow_audit_events";
...
DROP POLICY IF EXISTS "rls_security_events" ON "security_events";
...
DROP POLICY IF EXISTS "rls_usage_records" ON "usage_records";
...
DROP POLICY IF EXISTS "rls_agent_usage_records" ON "agent_usage_records";
...
ALTER TABLE "assessment_risk_register" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_assessment_risk_register" ON "assessment_risk_register";
...
ALTER TABLE "control_assessment_status" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_control_assessment_status" ON "control_assessment_status";
...
ALTER TABLE "scf_versions" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_versions" ON "scf_versions";
...
ALTER TABLE "scf_domains" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_domains" ON "scf_domains";
...
ALTER TABLE "scf_controls" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_controls" ON "scf_controls";
...
ALTER TABLE "scf_frameworks" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_frameworks" ON "scf_frameworks";
...
ALTER TABLE "scf_framework_requirements" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_framework_requirements" ON "scf_framework_requirements";
...
ALTER TABLE "scf_mappings" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_mappings" ON "scf_mappings";
...
ALTER TABLE "scf_control_metadata" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_control_metadata" ON "scf_control_metadata";
...
ALTER TABLE "scf_assessment_objectives" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_assessment_objectives" ON "scf_assessment_objectives";
...
ALTER TABLE "scf_evidence_requests" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_evidence_requests" ON "scf_evidence_requests";
...
ALTER TABLE "scf_maturity_criteria" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_maturity_criteria" ON "scf_maturity_criteria";
...
ALTER TABLE "scf_risks" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_risks" ON "scf_risks";
...
ALTER TABLE "scf_risk_control_mappings" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_risk_control_mappings" ON "scf_risk_control_mappings";
...
ALTER TABLE "scf_threats" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_threats" ON "scf_threats";
...
ALTER TABLE "scf_threat_control_mappings" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "rls_scf_threat_control_mappings" ON "scf_threat_control_mappings";
