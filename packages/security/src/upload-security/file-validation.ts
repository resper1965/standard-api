...
import type { MalwareScanProvider, MalwareScanResult } from "./malware-scan.placeholder";
...
export class FileSecurityService {
  ...
  async validate(file: SecurityFileDescriptor): Promise<FileValidationSecurityResult & { malwareScan?: MalwareScanResult }> {
