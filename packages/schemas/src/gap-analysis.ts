...
export const GapEvidenceStrengthSchema = z.enum([
  "strong",
  "partial",
  "weak",
  "absent",
...
export const GapAnalysisVersionStatusSchema = z.enum([
  "draft",
  "under_review",
  "approved",
  "superseded",
...
export const GapFindingTypeSchema = z.enum([
  "documentation_gap",
  "implementation_gap",
  "evidence_gap",
  "effectiveness_gap",
...
export type GapAnalysisVersionStatus = z.infer<
  typeof GapAnalysisVersionStatusSchema
>;
...
export type EvidenceFindingResponse = z.infer<
  typeof EvidenceFindingResponseSchema
>;
export type EvidenceSourceResponse = z.infer<
  typeof EvidenceSourceResponseSchema
>;
export type RunEvidenceAnalysisRequest = z.infer<
  typeof RunEvidenceAnalysisRequestSchema
>;
export type RunEvidenceAnalysisResponse = z.infer<
  typeof RunEvidenceAnalysisResponseSchema
>;
export type RefreshEvidenceFindingRequest = z.infer<
  typeof RefreshEvidenceFindingRequestSchema
>;
export type GapAnalysisVersionResponse = z.infer<
  typeof GapAnalysisVersionResponseSchema
>;
export type GapFindingResponse = z.infer<typeof GapFindingResponseSchema>;
export type CreateGapAnalysisDraftRequest = z.infer<
  typeof CreateGapAnalysisDraftRequestSchema
>;
export type UpdateGapFindingRequest = z.infer<
  typeof UpdateGapFindingRequestSchema
>;
export type GapAnalysisValidationResponse = z.infer<
  typeof GapAnalysisValidationResponseSchema
>;
export type SubmitGapAnalysisReviewRequest = z.infer<
  typeof SubmitGapAnalysisReviewRequestSchema
>;
export type ApproveGapAnalysisRequest = z.infer<
  typeof ApproveGapAnalysisRequestSchema
>;
