...
export type ObservabilityRepository<T extends { id: string; created_at?: string | undefined; trace_id: string }> = {
  ...
  list(filter?: { organization_id?: string | undefined; assessment_id?: string | undefined; limit?: number | undefined }): Promise<T[]>;
};

const matches = <T extends { organization_id?: string | undefined; assessment_id?: string | undefined }>(
  record: T,
  filter?: { organization_id?: string | undefined; assessment_id?: string | undefined }
): boolean =>
  (!filter?.organization_id || record.organization_id === filter.organization_id) &&
  (!filter?.assessment_id || record.assessment_id === filter.assessment_id);

export const createInMemoryRepository = <T extends { id: string; trace_id: string; organization_id?: string | undefined; assessment_id?: string | undefined }>() => {
  ...
  return {
    ...
    async list(filter?: { organization_id?: string | undefined; assessment_id?: string | undefined; limit?: number | undefined }) {
