...
**Files:**
- Modify: `c:/Users/resper/OneDrive/Área de Trabalho/aegis-api/packages/security/src/auth/jwt-auth-provider.placeholder.ts`
- Modify: `c:/Users/resper/OneDrive/Área de Trabalho/aegis-api/packages/security/src/index.ts`

- [ ] **Step 1: O código JWT real**
Implementar o verificador de contexto baseado na interface nativa `AuthProvider` do Aegis. Consumir e propagar scopes, tenant e rastreabilidade (`traceId`).
- [ ] **Step 2: Exportar**
...
**Files:**
- Create: `c:/Users/resper/OneDrive/Área de Trabalho/aegis-api/packages/schemas/src/db/connection.ts` (ou local pertinente já criado)
...
**Files:**
- Modify: `c:/Users/resper/OneDrive/Área de Trabalho/aegis-api/apps/api-gateway/src/middleware/auth.middleware.ts`
