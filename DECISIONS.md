...
- `docs/decisions/0003-edge-vector-storage.md`: Cloudflare Vectorize para embeddings.
- `docs/decisions/0004-durable-workflows.md`: Cloudflare Workflows para aprovações.
- `docs/decisions/0005-standard-native-auth-identity-provider.md`: Standard Native Auth (Edge Hash) como identity provider.
